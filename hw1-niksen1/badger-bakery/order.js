...
function calculateSalesTax() {
	...
	const currentState = document.getElementById("state-tax").value;
    const salesTaxRateForState = getSalesTaxRateForState(currentState);
    const salesTax = subtotal * salesTaxRateForState;
